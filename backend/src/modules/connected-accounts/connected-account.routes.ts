...
async function createGoogleConnectUrl(req: AuthRequest) {
  ...
  if (!config) {
    throw new Error('Kredensial Google OAuth belum dikonfigurasi. Silakan gulir ke bawah ke bagian "Google OAuth Credentials" di halaman Setting ini untuk menyimpan Client ID & Client Secret Anda terlebih dahulu.')
  }
